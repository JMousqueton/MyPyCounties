...
Usage:
    ...
    # Get coordinates by country code
...
country_coordinates = {
    ...
    'AX': ("Åland Islands", 60.1785247, 19.9156105),
    ...
    'CV': ("Cabo Verde", 16.002082, -24.013197),
    ...
    'CD': ("Congo (Democratic Republic of the)", -4.038333, 21.758664),
    'CG': ("Congo", -0.228021, 15.827659),
    'CK': ("Cook Islands", -21.236736, -159.777671),
    'CR': ("Costa Rica", 9.748917, -83.753428),
    'HR': ("Croatia", 45.1, 15.2),
    'CU': ("Cuba", 21.521757, -77.781167),
    'CW': ("Curaçao", 12.169570, -68.990020),
    'CY': ("Cyprus", 35.126413, 33.429859),
    'CZ': ("Czechia", 49.817492, 15.472962),
    'CI': ("Côte d'Ivoire", 7.539989, -5.54708),
    ...
    'VA': ("Holy See", 41.902916, 12.453389),
    ...
    'KP': ("Korea (Democratic People's Republic of)", 40.339852, 127.510093),
    'KR': ("Korea (Republic of)", 35.907757, 127.766922),
    'KW': ("Kuwait", 29.31166, 47.481766),
    'KG': ("Kyrgyzstan", 41.20438, 74.766098),
    'LA': ("Lao People's Democratic Republic", 19.85627, 102.495496),
    ...
    'FM': ("Micronesia (Federated States of)", 7.425554, 150.550812),
    'MD': ("Moldova (Republic of)", 47.411631, 28.369885),
    ...
    'MK': ("North Macedonia", 41.608635, 21.745275),
    ...
    'PS': ("Palestine, State of", 31.952162, 35.233154),
    ...
    'PN': ("Pitcairn", -24.703615, -127.439308),
    ...
    'BL': ("Saint Barthélemy", 17.9, -62.833333),
    'SH': ("Saint Helena, Ascension and Tristan da Cunha", -24.143474, -10.030696),
    'KN': ("Saint Kitts and Nevis", 17.357822, -62.782998),
    'LC': ("Saint Lucia", 13.909444, -60.978893),
    'MF': ("Saint Martin (French part)", 18.08255, -63.052251),
    ...
    'SX': ("Sint Maarten (Dutch part)", 18.034718, -63.068111),
    ...
    'SY': ("Syrian Arab Republic", 34.802075, 38.996815),
    'TW': ("Taiwan, Province of China", 23.69781, 120.960515),
    'TJ': ("Tajikistan", 38.861034, 71.276093),
    'TZ': ("Tanzania, United Republic of", -6.369028, 34.888822),
    ...
    'GB': ("United Kingdom of Great Britain and Northern Ireland", 55.378051, -3.435973),
    'US': ("United States of America", 37.09024, -95.712891),
    'UM': ("United States Minor Outlying Islands", 0, 0),
    'UY': ("Uruguay", -32.522779, -55.765835),
    'UZ': ("Uzbekistan", 41.377491, 64.585262),
    'VU': ("Vanuatu", -15.376706, 166.959158),
    'VE': ("Venezuela (Bolivarian Republic of)", 6.42375, -66.58973),
    'VN': ("Viet Nam", 14.058324, 108.277199),
    'VG': ("Virgin Islands (British)", 18.420695, -64.639968),
    'VI': ("Virgin Islands (U.S.)", 18.335765, -64.896335),
