...
country_coordinates = {
    ...
    'CD': (-4.038333, 21.758664),  # Congo (Democratic Republic)
    ...
    'VA': (41.902916, 12.453389),  # Holy See
    ...
    'SX': (18.034718, -63.068111), # Sint Maarten
...
def get_coordinates(country_code):
    ...
    return country_coordinates.get(country_code.upper(), None)
